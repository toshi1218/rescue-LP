...
export const COUNTRY_CONFIGS: CountryConfig[] = [
  ...
  },
  {
    ...
    badges: ['HK Immigration-Ready', 'DFA Apostille Included', 'Ships to Hong Kong via DHL'],
    isHagueConvention: true,
    authLabel: 'DFA Apostille',
    shippingDays: '2–4 business days',
    totalWeeks: '3–5 weeks',
    price: '899',
    summaryPoints: [
      'Hong Kong (HKSAR) accepts DFA Apostille on Philippine documents for immigration applications',
      'CENOMAR, PSA Birth Certificate, NBI Clearance, Marriage Certificate available',
    ...
    faqs: [
      {
        q: 'Does Hong Kong require DFA Apostille on Philippine documents?',
        a: 'Yes. Hong Kong (HKSAR) accepts DFA Apostille authentication on Philippine civil documents for immigration applications including dependant visa and other sponsored entries.',
      },
      {
        q: 'What documents are needed for a Hong Kong Dependant Visa?',
        a: 'Typically PSA Birth Certificate with DFA Apostille and NBI Clearance for Hong Kong Immigration applications. PSA Marriage Certificate is required for spousal dependant applications. We confirm for your specific case.',
      },
      {
        q: 'How much does it cost?',
