...
const ja = {
  ...
  'hero.description': '国際結婚・配偶者ビザ・外免切替で必要な書類を整理し、フィリピンでの取得・アポスティーユ対応まで進めます。多くの案件で渡航不要、日本語でご相談いただけます。',
  ...
  'footer.nameLabel': 'お名前（任意・匿名相談OK）',
  'footer.namePlaceholder': '匿名でもご相談いただけます',
  ...
  'footer.messageLabel': '提出先・希望期限・相談内容',
  'footer.messagePlaceholder': '例：○○市役所へ提出予定、11月末まで。出生証明書とCENOMARが必要か相談したい。',
  'footer.submit': '無料で見積もりを依頼する',
  'footer.submitAriaLabel': '無料見積もりを依頼する',
  ...
  'painpoints.3.desc': '提出先・申請段階によってアポスティーユの要否や形式（e-Apostille／紙）・必要部数が変わり、揃え方が分かりにくい',
  ...
  'whyus.1.desc': '提出先・手続き段階によって、e-Apostilleの受理可否や紙原本の要否・必要部数が変わります。用途と提出先を確認し、必要な形式を整理します。',
  ...
  'whyus.4.desc': '株式会社IGRS（和歌山登記）として、会社概要・特定商取引法に基づく表記・返金条件を公開しています。ご依頼前に確認できます。',
  'whyus.stat1.label': '依頼方法',
  'whyus.stat1.value': '多くの案件で渡航不要',
  'whyus.stat2.label': '着手前キャンセル無料',
  ...
  'whyus.guarantee.success': '当社の手配上の理由で書類を取得できなかった場合、着手金を全額返金いたします。',
...
const en: typeof ja = {
  ...
  'hero.description': 'We retrieve PSA Birth Certificates, CENOMAR, NBI Clearance, and DFA Apostille from the Philippines for marriage, immigration, and visa applications worldwide. No Philippine contacts or local knowledge required — shipped via DHL to your door.',
  ...
  'whyus.cta': 'Free consultation',
  'whyus.ctaAriaLabel': 'Start free consultation',
