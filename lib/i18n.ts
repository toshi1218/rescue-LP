...
const ja = {
  ...
  'hero.h1line3': '紙1枚ではなく、日本提出で使える状態まで整えます。',
  'hero.description': '国際結婚・配偶者ビザ・外免切替に必要な書類の確認・取得・認証・翻訳・配送に加え、電子アポスティーユが必要な案件では提出先向けの確認資料まで一式でご用意します。渡航不要・日本語のみで完結します。',
  ...
  'whyus.1.desc': '提出先・手続き段階によって、アポスティーユの要否や形式（e-Apostille／紙）・必要部数が変わります。用途と提出先を確認し、日本側で止まらない形に整えます。',
