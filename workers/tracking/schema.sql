-- D1 schema for the customer tracking portal and the unified IGRS CRM.
-- Apply with: wrangler d1 execute ph-document-tracking --file=./schema.sql --remote
...
CREATE INDEX IF NOT EXISTS idx_crm_messages_cursor ON crm_messages(id);
