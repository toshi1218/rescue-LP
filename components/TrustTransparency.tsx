...
const contentData = {
  ja: {
    ...
    heading: '「本当に大丈夫？」\nその不安、正確に言葉にできますか？',
    subheading:
      'フィリピンの書類手続きで感じる不安の正体は「スピード」ではありません。\n「何が起きているか分からない」という透明性への不安です。',
    fears: [
      {
        icon: AlertCircle,
      ...
      },
      {
        ...
        answer:
          '現地機関との交渉はすべて代行します。お客様は日本語でご連絡いただくだけで完結します。',
      },
      {
        icon: FileCheck,
        fear: '「書類が揃わなかったり、不備で差し戻されたら？」',
        answer:
          '提出前に必要書類を一式確認し、不備リスクを事前に排除します。万が一の場合も対応します。',
      },
      {
        icon: ShieldCheck,
      ...
      },
      {
        ...
        answer:
          'ご依頼時に着手金50%、書類取得・DHL配送準備完了後に残金50%（成功報酬）をお支払いいただくシステムです。着手前キャンセルは無料です。',
      },
    ],
    promise: {
      heading: '私たちの3つの約束',
      items: [
        { label: '進捗が見える', desc: '申請・受理・発送の各段階でご報告。「待つだけ」にしません。' },
        { label: '日本語で完結', desc: '現地交渉から書類確認まで、すべて日本語でやり取りできます。' },
        { label: '確実に揃える', desc: '提出前に書類を一式確認。不備リスクを事前に排除します。' },
      ],
    },
    cta: '不安なことを、まず相談してみる',
