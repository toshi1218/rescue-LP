...
const guidesData = {
  ja: [
    ...
    { to: '/ja/haigusha-visa-shorui/',  title: '配偶者ビザ必要書類【2026年3月版】', desc: '2025年6月〜の結核証明書追加を含む最新版', tag: '2026年版' },
    { to: '/ja/kekkaku-shomeisho/',    title: '結核非発病証明書ガイド',           desc: 'COE申請で2025年6月〜フィリピン国籍者に必須', tag: '新着' },
