  ...
  return (
    <footer className="bg-white border-t border-gray-100" id="contact">
      <div className="py-16 max-w-md md:max-w-xl mx-auto px-6 text-center">
        ...
        {/* LINE quick contact — Japanese only */}
        {isJa && !submitted && (
          <div className="mb-5">
            <a
              ...
              onClick={() => trackEvent('cta_click', { location: 'footer', type: 'line', variant: ctaVariant })}
              className="flex items-center justify-center gap-2 w-full py-3 px-6 rounded-xl bg-[#06C755] text-white font-bold text-sm hover:opacity-90 transition-opacity shadow-sm"
            >
            ...
            <p className="text-[10px] text-gray-400 text-center mt-1">LINEアカウントをお持ちの方はこちらからもご相談いただけます</p>
          </div>
        )}
