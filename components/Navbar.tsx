      ...
      <div className="border-t border-gray-100 bg-white/95">
        <div className="max-w-md md:max-w-2xl lg:max-w-4xl mx-auto">
          <div className="flex overflow-x-auto scrollbar-hide px-2 gap-1 py-1.5">
            ...
            <Link to={isJa ? '/ja/kokusai-kekkon-guide' : '/en/international-marriage-guide'} className={linkClass(isJa ? '/ja/kokusai-kekkon-guide' : '/en/international-marriage-guide')}>{isJa ? '国際結婚ガイド' : 'Marriage Guide'}</Link>
        ...
        <div className="md:hidden fixed inset-0 top-[104px] z-[200] bg-white overflow-y-auto">
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="border-t border-gray-100 pt-2 mt-2 space-y-0.5">
              ...
              <Link to={isJa ? '/ja/kokusai-kekkon-guide' : '/en/international-marriage-guide'} className="block px-3 py-3 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50">{isJa ? '国際結婚ガイド' : 'Marriage Guide'}</Link>
