...
const plansData = {
  ...
  en: [
    ...
    },
    {
      ...
      subtitle: 'Physical PSA original shipped via DHL — add the appropriate DFA authentication route when required',
      price: 'US$199',
    ...
    },
    {
      ...
      subtitle: 'Physical PSA original, not an e-certificate — add the appropriate DFA authentication route when required',
      price: 'US$199',
      priceNote: 'document + DHL (no Apostille)',
      priceApostille: 'US$349',
      period: 'Approx. 4–6 weeks',
