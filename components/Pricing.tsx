...
const plansData = {
  ja: [
    ...
    },
    {
      ...
      includes: ['CENOMAR（独身証明書）', 'PSA出生証明書', 'DFA e-Apostille認証（電子）', 'DHL国際発送'],
      ...
      price: '¥55,000',
      priceNote: '〜（税込・DHL込み）',
      priceBreakdown: 'パック料金 ¥50,000 + 消費税 ¥5,000（DHL国際発送込み）',
      period: '約4〜6週間',
    ...
    },
    {
      ...
      includes: ['PSA婚姻証明書', 'PSA出生証明書', 'DFA e-Apostille認証（電子）', 'DHL国際発送'],
    ...
    },
    {
      ...
      priceEApostilleNote: '※e-Apostille（電子）のみのため送料不要。紙のPSA原本（SECPA）も必要な場合は+¥10,000（¥40,000〜）＋DHL国際発送 ¥6,000',
      period: '約4〜6週間',
