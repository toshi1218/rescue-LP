...
const plansData = {
  ja: [
    ...
    },
    {
      ...
      subtitle: 'e-Certificate・e-Apostille・SECPA紙原本・DHLをまとめて手配',
      why: '国際結婚の婚姻届や配偶者ビザ申請では、フィリピン側の独身証明書（CENOMAR）をアポスティーユ付きで用意する必要があります',
      outcome: 'CENOMAR原本が揃えば、婚姻届の受理やビザ申請書類の準備が前に進みます',
      price: '¥50,000',
      priceNote: '（税込・DHL込み）',
      priceBreakdown: 'e-Certificate・e-Apostille・SECPA紙原本・DHL国際送料を含む総額',
      priceEApostille: '¥40,000',
      priceEApostilleNote: '電子版のみは¥30,000、e-Apostille付き電子版は¥40,000（いずれも税込）',
      period: '約4〜6週間',
