...
const plansData = {
  ja: [
    ...
    },
    {
      ...
      includes: ['CENOMAR（独身証明書）オンライン申請', 'PSA出生証明書オンライン申請', 'DFA e-Apostille認証（電子）×2', '入力・支払い代行'],
      why: '日本の役所で婚姻届を出すには、フィリピン側の書類（出生証明・独身証明など）をアポスティーユ付きで用意する必要があります。2026年3月以降、PSA民事書類の認証はe-Apostille（電子）です',
      outcome: '書類が揃えば、日本の市区町村への婚姻届の提出が可能になります',
      price: '¥55,000',
      priceNote: '〜（税込 / PSA申請＋DFA e-Apostille代行）',
      priceBreakdown: 'パック料金 ¥50,000 + 消費税 ¥5,000',
      period: '約4〜6週間',
    ...
    },
    {
      ...
      includes: ['PSA婚姻証明書オンライン申請', 'PSA出生証明書オンライン申請', 'DFA e-Apostille認証（電子）×2', '入力・支払い代行'],
      why: '入管への配偶者ビザ申請では、フィリピン側の婚姻・出生証明書をアポスティーユ付きで提出する必要があります。2026年3月以降、PSA民事書類の認証はe-Apostille（電子）です',
    ...
    },
    {
      ...
      featured: false,
      title: 'PSA出生証明書単品',
      subtitle: 'PSA出生証明書のオンライン申請＋DFA e-Apostille（電子）代行（1点から対応）',
    ...
    },
    {
      ...
      featured: false,
      title: 'PSA婚姻証明書単品',
      subtitle: 'PSA婚姻証明書のオンライン申請＋DFA e-Apostille（電子）代行（1点から対応）',
    ...
    },
    {
      ...
      includes: ['PSA出生証明書オンライン申請', 'PSA婚姻証明書 or CENOMAR オンライン申請', 'NBI Clearance 物理アポスティーユ代行', 'PSA=e-Apostille（電子）／NBI=物理アポスティーユ', 'NBI原本のDHL国際発送'],
      why: '帰化申請では法務局からフィリピンの出生・婚姻・無犯罪証明書などの原本提出が求められます。PSA民事書類はe-Apostille（電子）、NBIは物理アポスティーユで対応します',
      outcome: '必要書類が揃えば、法務局への帰化申請の書類準備が整います',
      price: '¥94,000',
      priceNote: '〜（税込 / PSA申請＋e-Apostille＋NBI物理アポスティーユ・DHL込み）',
      priceBreakdown: 'パック料金 ¥80,000 + 消費税 ¥8,000 + DHL（NBI原本）¥6,000',
      period: '約6〜10週間',
  ...
  en: [
    {
      ...
      subtitle: 'PSA Birth Certificate & CENOMAR online applications with DFA e-Apostille — ready for marriage registration',
      price: 'US$249',
      priceNote: 'all-in',
    ...
    },
    {
      ...
      subtitle: 'PSA & CENOMAR online applications (DFA e-Apostille) + NBI retrieval (physical Apostille) — for marriage, spouse visa & immigration',
      price: 'US$449',
      priceNote: 'all-in',
      period: 'Approx. 4–6 weeks',
      detailPath: '/en/international-marriage-guide/',
    },
    {
      ...
      subtitle: 'CENOMAR online application + DFA e-Apostille (electronic), handled for you — for immigration use worldwide',
      price: 'US$119',
      priceNote: 'online application (no Apostille)',
      priceApostille: 'US$219',
      period: 'Approx. 4–6 weeks',
    ...
    },
    {
      ...
      subtitle: 'PSA Birth Certificate online application + DFA e-Apostille (electronic), handled for you',
      price: 'US$119',
      priceNote: 'online application (no Apostille)',
      priceApostille: 'US$219',
      period: 'Approx. 4–6 weeks',
    ...
    },
    {
      ...
      subtitle: 'PSA Marriage Certificate online application + DFA e-Apostille (electronic) for spouse visa, immigration, and naturalization',
      price: 'US$119',
      priceNote: 'online application (no Apostille)',
      priceApostille: 'US$219',
      period: 'Approx. 4–6 weeks',
