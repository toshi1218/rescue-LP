...
const plansData = {
  ja: [
    {
      ...
      subtitle: 'PSAの電子証明書を1種類から取得。PDFで納品するためDHL送料はかかりません',
      includes: [
        'PSAオンラインフォームへの入力・申請',
        '本人確認・申請費用の支払い手続き',
        'PSA e-Certificate（PDF）の取得',
        '申請後のステータス確認・電子納品',
      ],
      why: 'PSAのオンライン申請には本人確認（ライブネスチェック）・英語フォーム入力・国際決済が必要です。取得までを代行し、e-CertificateをPDFで納品します。DFA e-Apostilleが必要な場合は追加できます',
      price: '¥30,000',
      priceNote: '（税込 / オンライン完結）',
      priceBreakdown: 'PSA e-Certificate 1種類の取得・電子納品を含む総額',
    ...
    },
    {
      ...
      featured: false,
      title: '国際結婚準備パック（電子版）',
      subtitle: 'CENOMAR・PSA出生証明書を e-Certificate＋DFA e-Apostille（いずれも電子）で取得。紙原本の発送はありません',
      includes: ['CENOMAR（PSA e-Certificate）', 'PSA出生証明書（e-Certificate）', 'DFA e-Apostille 認証（電子）', 'PDFでの納品'],
      why: '提出先が PSA e-Certificate と DFA e-Apostille を受理する場合は、紙原本を取り寄せずに電子データだけで手続きを進められます。受理されるかは書類の有効性ではなく提出先がその形式を受け付けるかで決まるため、事前確認をおすすめします。',
      outcome: '電子データが揃えば、電子版を受理する提出先への申請を進められます。紙原本を求められた場合は上の「国際結婚準備パック」（SECPA紙原本つき）をご利用ください。',
      price: '¥65,000',
      priceNote: '（税込・書類2種）',
    ...
    },
    {
      ...
      subtitle: '電子版・紙原本・e-Apostille付きから、提出先に合う形式を選択',
      why: '国際結婚の婚姻届や配偶者ビザ申請ではCENOMARを求められることがあります。紙原本やe-Apostilleの要否は提出先により異なります',
    ...
    },
    {
      ...
      title: 'PSA出生証明書単品',
      subtitle: '電子版・紙原本・e-Apostille付きから、提出先に合う形式を選択',
      why: 'パスポート・ビザ・帰化・国際結婚など、用途に合う形式で手配します。紙原本やe-Apostilleの要否は提出先により異なります',
    ...
    },
    {
      ...
      title: 'PSA婚姻証明書単品',
      subtitle: '電子版・紙原本・e-Apostille付きから、提出先に合う形式を選択',
      why: '配偶者ビザ・帰化・在留資格変更など、用途に合う形式で手配します。紙原本やe-Apostilleの要否は提出先により異なります',
    ...
    },
    {
      ...
      why: 'すでにNBI Clearance原本をお持ちの方向けです。原本をIGRS宛に転送いただくことで、DFA物理アポスティーユの取得から国際発送までを代行します。取得そのものからご依頼の場合は下の「NBIクリアランス取得代行＋DFAアポスティーユ」をご覧ください。',
    ...
    },
    {
      ...
      tag: null,
      featured: false,
      title: 'NBIクリアランス取得代行＋DFAアポスティーユ',
      subtitle: 'ポータル登録・支払い・取得・DFAアポスティーユ・原本の国際発送までを一括代行',
      includes: ['NBIポータル登録・支払い代行', 'NBI Clearance取得', 'DFAアポスティーユ認証', 'DHL国際発送（原本）'],
      why: '初回取得は在日フィリピン大使館・総領事館でご本人の指紋対応（Form No.5）が必要です。指紋対応がお済みの方であれば、その後のポータル登録から取得・認証・発送までを当社で代行できます。',
      outcome: 'アポスティーユ付きNBI Clearance原本が届き、帰化申請・ビザ申請の書類セットが完成します',
      price: '¥55,000',
      priceNote: '（税込・DHL送料込みの総額）',
      priceBreakdown: '取得代行・DFAアポスティーユ・DHL国際送料をすべて含む総額（追加費用なし）',
      period: '約4〜6週間',
      detailPath: '/ja/nbi-clearance/',
    },
    {
  ...
  en: [
    ...
    },
    {
      id: 'family-3',
      icon: Gem,
      tag: 'BEST VALUE FOR 3',
      featured: false,
      title: '3-Applicant PSA + NBI Family Package',
      subtitle: 'Three PSA Birth Certificates, three first-time NBI Clearances, DFA Apostilles, case coordination & one DHL shipment',
      includes: [
        '3 PSA Birth Certificates + DFA e-Apostilles',
        '3 first-time NBI Clearances + DFA Apostilles',
        'Authorization Letters and progress updates',
        'One consolidated DHL Express shipment',
      ],
      outcome: 'All three applicants receive a coordinated document set for one destination country and purpose',
      price: 'US$1,249',
      priceNote: 'total for 3 applicants',
      period: 'Approx. 6–7 weeks',
      detailPath: '/en/family-psa-nbi-package/',
    },
    {
      id: 'cenomar',
      icon: FileText,
      ...
      <div className="max-w-5xl mx-auto">
        {lang === 'ja' && (
          <div className="text-xs text-gray-500 mb-6 space-y-0.5">
            <p>※表示価格はすべて税込です。DHL込みの記載があるプランは国際送料も含みます</p>
