  ...
  ja: [
    {
      ...
      why: '海外からPSAへのオンライン申請は、①申請サイトの選定（英語サイト）、②英語でのフォーム入力、③国際送金、④送付先の手続き・追跡など、複数のハードルがあります。サポートを受けながら自分で申請したい方向けのプランです。なお、日本の提出先（役所・入管など）が紙原本を必須とする場合は、後述のフルサービスへの切替もご相談いただけます',
      price: '¥15,000',
      priceNote: '〜（税別／税込¥16,500〜）',
