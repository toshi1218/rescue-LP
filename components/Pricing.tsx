  ...
  en: [
    {
      ...
      price: 'US$289–359',
      usdRef: '$289',
      note: '(tax & DHL shipping incl.)',
      highlights: ['Gov\'t filing fees included', 'DHL shipping incl.'],
      details: {
        period: 'Approx. 4–6 weeks',
        note: '* Incl. tax & DHL intl. shipping',
    ...
    },
    {
      ...
      usdRef: '$329',
      note: '(tax & DHL shipping incl.)',
      highlights: ['Fingerprint support included', 'DHL shipping incl.'],
      details: {
        period: 'Approx. 4–6 weeks',
        note: '* Incl. tax & DHL intl. shipping',
        docs: ['NBI Clearance (+ Apostille)'],
      },
      featured: false,
    },
    {
    ...
    },
    {
      ...
      usdRef: '$799',
      note: '(tax & DHL shipping incl.)',
      highlights: ['Japanese translation included', 'DHL shipping incl.'],
      details: {
        period: 'Approx. 4–6 weeks',
        note: '* Incl. tax & DHL intl. shipping',
