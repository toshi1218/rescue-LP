...
const plansData = {
  ja: [
    ...
    },
    {
      ...
      subtitle: 'PSA発行のCENOMAR取得・アポスティーユ・国際発送（1点から対応）',
      why: '国際結婚の婚姻届や配偶者ビザ申請では、フィリピン側の独身証明書（CENOMAR）をアポスティーユ付きで用意する必要があります',
      outcome: 'CENOMAR原本＋アポスティーユが揃えば、婚姻届の受理やビザ申請書類の準備が前に進みます',
      price: '¥58,000',
      priceNote: '〜（税込・DHL送料込み）',
      period: '約4〜6週間',
    ...
    },
    {
      ...
      featured: false,
      title: 'PSA出生証明書単品',
      subtitle: 'PSA発行の出生証明書取得・アポスティーユ・国際発送（1点から対応）',
      why: 'ビザ申請・帰化・国際結婚の手続きでは、PSA発行の出生証明書原本をアポスティーユ付きで提出する必要があります',
      outcome: 'PSA出生証明書原本＋アポスティーユが揃えば、ビザや婚姻手続きの書類準備が前に進みます',
      price: '¥58,000',
      priceNote: '〜（税込・DHL送料込み）',
      period: '約4〜6週間',
    ...
    },
    {
      ...
      featured: false,
      title: 'PSA婚姻証明書単品',
      subtitle: 'PSA発行の婚姻証明書取得・アポスティーユ・国際発送（1点から対応）',
      why: '配偶者ビザ申請・帰化・在留資格変更などの手続きでは、PSA発行の婚姻証明書原本をアポスティーユ付きで提出する必要があります',
      outcome: 'PSA婚姻証明書原本＋アポスティーユが揃えば、ビザや帰化手続きの書類準備が前に進みます',
      price: '¥58,000',
      priceNote: '〜（税込・DHL送料込み）',
      period: '約4〜6週間',
    ...
    },
    {
      ...
      tag: null,
      featured: false,
      title: '再婚・記載不一致・late registration等の難件',
      subtitle: '再婚・氏名不一致・出生届未登録など通常フローでは対応が複雑な案件',
      why: '再婚歴・記載不一致・late registrationなど特殊な事情がある場合は、追加手続きや当局との調整が必要になります',
      outcome: '個別に状況を確認し、対応可能な範囲と費用をご案内します',
      price: '¥198,000',
      priceNote: '〜',
      period: '案件による',
      detailPath: '#contact',
  ...
  en: [
    ...
    },
    {
      ...
      subtitle: 'Certificate of No Marriage Record for K-1, CR-1, marriage registration, and spouse visa',
      price: 'US$249',
      priceNote: 'all-in',
      period: 'Approx. 4–6 weeks',
    ...
    },
    {
      ...
      subtitle: 'Physical PSA birth certificate for immigration, visa, and civil registration abroad',
      price: 'US$249',
      priceNote: 'all-in',
      period: 'Approx. 4–6 weeks',
    ...
    },
    {
      ...
      subtitle: 'Physical PSA marriage certificate for spouse visa, immigration, and naturalization applications',
      price: 'US$249',
      priceNote: 'all-in',
      period: 'Approx. 4–6 weeks',
      ...
      <div className="max-w-5xl mx-auto">
        {lang === 'ja' && (
          <div className="text-xs text-gray-500 mb-6 space-y-0.5">
            <p>表示価格は、書類取得・必要な場合のDFAアポスティーユ・DHL国際送料込みです。</p>
            <p>記載不一致、再婚、late registration、緊急対応、追加書類がある場合は別途お見積もりします。</p>
          </div>
        )}
