...
const faqsData = {
  ja: [
    ...
    { q: '取得にはどのくらいかかりますか？', a: 'PSAの電子版は約1週間、紙原本の国際発送が必要な場合は約3〜4週間が目安です。NBI・LTOなどは案件により異なります。提出予定日がある場合は、できるだけ早めにご相談ください。' },
  ...
  en: [
    ...
    { q: 'What documents are needed for a K-1 or CR-1 visa?', a: 'The checklist differs by visa type and stage. PSA civil records and NBI Clearance may be requested, while authentication requirements must be checked against the current USCIS, NVC, or embassy instructions for your case.' },
