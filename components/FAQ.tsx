...
const faqsData = {
  ...
  en: [
    ...
    { q: 'What documents are needed for a K-1 or CR-1 visa?', a: 'The checklist differs by visa type and stage. PSA civil records and NBI Clearance may be requested, while Apostille requirements must be confirmed with the current USCIS, NVC, or embassy instructions. We check the official requirements for your case.' },
