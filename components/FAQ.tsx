...
const faqsData = {
  ja: [
    { q: '費用はいくらかかりますか？', a: 'CENOMAR・PSA書類は¥50,000〜、NBI Clearanceは¥55,000〜、LTO書類は¥100,000〜が目安です。必要書類の組み合わせやDFAアポスティーユ認証の有無で変わります。無料相談時に正確なお見積もりをご案内します。' },
    { q: '取得にどのくらいかかりますか？', a: '目安は約4〜6週間です。書類の種類や現地の取得状況により前後します。提出予定日が決まっている場合は、逆算してスケジュールをご案内しますので、まずご相談ください。' },
