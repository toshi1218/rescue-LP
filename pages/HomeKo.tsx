...
export default function HomeKo() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: '필리핀 측 서류（CENOMAR, PSA 출생증명서, NBI Clearance, 아포스티유）를 대행합니다. LCCM（혼인요건증명서）에 관한 안내도 가능합니다.',
    },
    {
      q: '얼마나 걸리나요?',
    ...
    {
      q: '결제는 어떻게 하나요?',
      a: '착수금 50%를 입금하신 후 진행을 시작합니다. 서류 사본 확인 후 나머지 50%를 결제하시면 원본을 발송합니다.',
    },
  ];
