...
export default function ApostilleGuideEn() {
  ...
  return (
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'DFA Apostille is included in all service packages starting at US$219. For PSA documents this is the DFA e-Apostille application; for non-PSA documents such as NBI it is a physical Apostille with DHL shipping. See our Pricing page for the full breakdown.',
              },
            },
            {
              '@type': 'Question',
    ...
    >
      ...
      <FaqSection
        items={[
          { q: 'How much does it cost?', a: 'DFA Apostille is included in all service packages starting at US$219. For PSA documents this is the DFA e-Apostille application; for non-PSA documents such as NBI it is a physical Apostille with DHL shipping. See our Pricing page for the full breakdown.' },
