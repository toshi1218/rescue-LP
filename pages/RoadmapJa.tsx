...
export default function RoadmapJa() {
  ...
  return (
    ...
    >
      ...
      <HeroBanner
        title="フィリピン人パートナーと日本で結婚・同居するための個別ロードマップ"
      ...
      <section className="mb-12 space-y-4 text-sm md:text-base text-gray-700 leading-relaxed">
        ...
        <p>
          お二人の状況を事前にヒアリングしたうえで、必要書類、手続きの順番、提出先、全体の流れ、日本で一緒に暮らすまでの目安を整理し、あなたたち専用のロードマップとしてお渡しします。
        </p>
        <p className="font-semibold text-secondary">
          ただ情報を並べるのではなく、<br />
          「今自分たちがどこにいて、次に何をすればいいのか」が見える状態を作るためのサービスです。
        </p>
      </section>
