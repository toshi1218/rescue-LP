          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800 leading-relaxed mb-2">
                2026年3月16日より、PSAは婚姻証明書・出生証明書・CENOMARについてデジタル証明書（e-certificate）とDFA電子アポスティーユ（e-Apostille）の発行に完全移行しました。DFA窓口での紙の証明書に対する物理アポスティーユ申請は原則できなくなっています。
              </p>
              <p className="text-sm text-amber-800 leading-relaxed">
                <strong>入国管理局は、e-Apostilleのプリントアウトを原則として受け付けません。</strong>
