  ...
  return (
    ...
    >
      ...
      <SectionDivider variant="blue">
        ...
        <p className="text-sm text-gray-600 leading-relaxed mb-3">
          帰化申請での差し戻しを避けるため、当社は<strong>PSA出生証明書・婚姻証明書・CENOMAR等を紙の原本（SECPA）で取り寄せ、DFA e-Apostille（電子認証）を付してDHLでお届けする</strong>のを標準としています。前述のとおりPSA書類への物理アポスティーユは発行が停止されているため、紙のアポスティーユが必要と言われた場合は、その場で提出先へ確認する方法までご案内します。
        </p>
        <p className="text-sm text-gray-600 leading-relaxed mb-3">
      ...
      <FaqSection
        items={[
          ...
          { q: '紙のPSA原本の取得を依頼できますか？', a: 'はい。PSA出生証明書・婚姻証明書・CENOMAR等を紙の原本（SECPA）で取り寄せ、DFA e-Apostilleを付してDHLでお届けします。法務局の発行日指定にも対応します。無料相談で必要書類を整理します。' },
        ]}
