  ...
  const orgSchema = {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        {
          '@type': 'Offer',
          priceSpecification: { '@type': 'PriceSpecification', minPrice: '94000', priceCurrency: 'JPY' },
          itemOffered: { '@type': 'Service', name: '国際結婚準備パック（PSA出生証明書＋CENOMAR＋DFAアポスティーユ）', description: '日本での国際結婚手続きに必要なフィリピン側書類をまとめて代行取得。税込・DHL送料込み。' },
        },
        {
          '@type': 'Offer',
