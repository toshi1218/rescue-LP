...
export default function PsaMarriageCertJa() {
  ...
  return (
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'PSA婚姻証明書1通のフルセットは50,000円（税込・DHL込み）です。e-Certificateのみは30,000円、e-Apostille付き電子版は40,000円です。',
              },
            },
            {
              '@type': 'Question',
    ...
    >
      ...
      <FaqSection
        items={[
          { q: '料金はいくらですか？', a: 'PSA婚姻証明書1通のフルセットは50,000円（税込・DHL込み）です。e-Certificateのみは30,000円、e-Apostille付き電子版は40,000円です。' },
