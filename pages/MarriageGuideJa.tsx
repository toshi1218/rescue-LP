  ...
  return (
    ...
    >
      ...
      <CtaBox
        ...
        description="CENOMAR・PSA出生証明書・DFAアポスティーユをまとめた料金でご案内します。追加請求はありません。"
        buttonText="料金を確認する"
        href="#contact"
        variant="secondary"
      ...
      <StepList
        ...
        steps={[
          ...
          { title: '必要書類・料金の確認', description: '書類一式の料金をご提示します。ご依頼時に着手金50%、書類取得・DHL配送準備完了後に残金50%をお支払いいただきます。' },
