          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800 leading-relaxed mb-2">
                The PSA now issues civil registry documents exclusively as digital PSA eCertificates with a digital DFA e-Apostille. The Department of Home Affairs accepts e-Apostille PDFs submitted digitally in many cases, which can be faster and cheaper than a paper original if accepted for your case.
              </p>
              <p className="text-sm text-amber-800 leading-relaxed">
                Requirements vary by case, so <strong>confirm with Home Affairs first</strong> — we handle either a digital e-Apostille delivery or a physical paper original.
              </p>
            </div>
          </div>
        </div>
