...
export default function ServicePageTemplate({ lang, routePath, title, badges }: ServicePageTemplateProps) {
  ...
  return (
    ...
    >
      <HeroBanner title={title} badges={badges} ctaText={isJa ? '無料で相談する' : 'Free Consultation'} ctaHref="#contact" />
      ...
      <FaqSection
        items={isJa
          ? [
              ...
              { q: '提出予定日に合わせてスケジュールを組んでもらえますか？', a: '提出予定日をお知らせいただければ、逆算してスケジュールをご案内します。現地機関の処理状況により前後する場合がありますが、進捗は随時ご報告します。' },
            ]
          : [
