  ...
  return (
    <PageLayout breadcrumbs={[{ label: 'Home', href: '/en/' }, { label: 'Contact' }]}>
      ...
      <p className="text-xs text-gray-500 mb-4">
        You can reach us by email or LINE. The form below sends your message to our inbox.
      </p>
      ...
      <div className="mt-4 flex flex-col items-start gap-2">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-xs text-gray-500 hover:text-secondary transition-colors"
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#06C755" aria-hidden="true">
