      ...
      >
        ...
        <fieldset className="rounded-lg border border-gray-100 bg-gray-50/60 p-3">
          ...
          <div className="mb-3">
            ...
            <input
              name="copies"
              placeholder="e.g. 2 copies"
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm bg-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>

          <div className="mb-3">
            <label className="block text-sm font-bold text-gray-700 mb-1">Place of birth (city/municipality)</label>
            <input
              name="birthplace"
              placeholder="e.g. Cebu City, Manila"
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm bg-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>

          <div className="mb-3">
            <label className="block text-sm font-bold text-gray-700 mb-1">Do you already have the PSA original copy?</label>
            <select
              name="psa_original"
              defaultValue=""
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm bg-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            >
              <option value="">Select (optional)</option>
              <option value="Yes, I have the original">Yes, I have the original</option>
              <option value="No, need to request it">No, need to request it</option>
              <option value="Not sure">Not sure</option>
            </select>
          </div>

          <div className="mb-3">
            <label className="block text-sm font-bold text-gray-700 mb-1">Delivery destination country</label>
            <input
              name="delivery_country"
              placeholder="Only if different from country of residence"
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm bg-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>

          <div>
            <label className="block text-sm font-bold text-gray-700 mb-1">Desired deadline</label>
            <input
              name="desired_deadline"
              placeholder="e.g. Needed by end of August 2026"
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm bg-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
        </fieldset>
