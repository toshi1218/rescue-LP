        ...
        },
        {
          ...
          mainEntity: [
            ...
            },
            {
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'All-inclusive from US$349, covering CENOMAR retrieval, DFA Apostille, and DHL shipping worldwide. See our Pricing page for the full breakdown.',
              },
            },
            {
              '@type': 'Question',
    ...
    >
      ...
      <FaqSection
        items={[
          ...
          { q: 'How much does it cost?', a: 'All-inclusive from US$349, covering CENOMAR retrieval, DFA Apostille, and DHL shipping worldwide. See our Pricing page for the full breakdown.' },
