        ...
        },
        {
          ...
          mainEntity: [
            ...
            },
            {
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: '目安は約1ヶ月〜です。PSA発行に2〜3週間、DFAアポスティーユ取得に約2週間、郵送に3〜5営業日かかります。提出予定日が決まっている場合はご相談ください。',
              },
            },
            {
              '@type': 'Question',
    ...
    >
      ...
      <FaqSection
        items={[
          ...
          { q: 'いつ届きますか？', a: '目安は約1ヶ月〜です。PSA発行に2〜3週間、DFAアポスティーユ取得に約2週間、郵送に3〜5営業日かかります。提出予定日が決まっている場合は、逆算してスケジュールをご案内します。' },
