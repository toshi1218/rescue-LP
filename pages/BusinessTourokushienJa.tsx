...
export default function BusinessTourokushienJa() {
  ...
  return (
    ...
    >
      ...
      <SummaryBlock
        conclusion="フィリピン書類の代行業者には信頼性にばらつきがあります。IGRSは日本語対応・進捗メール報告・追加費用なしで確実に対応します。"
        points={[
          'CENOMAR・PSA出生証明書・NBI Clearance・DFAアポスティーユに対応',
          '複数名分の書類を並行して手配可能',
          '受理・取得・発送の各段階でメール報告（進捗が不明になることはありません）',
        ...
        <div className="rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-white to-secondary/5 overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="mt-4 text-xs text-gray-500 flex items-center gap-1.5">
              ...
              上記は税込・DHL国際送料込みの総額です。PSA民事書類の単品料金は、電子版のみ／SECPA紙原本のみ ¥30,000、e-Apostille付き ¥40,000、フルセット（電子＋e-Apostille＋SECPA紙原本＋DHL）¥55,000（いずれも税込）です。複数件・継続案件の料金はお問い合わせください
            </p>
          </div>
        </div>
      </section>
