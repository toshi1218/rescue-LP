          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'DFA e-ApostilleはRegular（通常5日程度）またはExpress（3日程度）で申請できます。PSAの電子版は約1週間、紙原本の国際発送が必要な場合は約3〜4週間が目安です。NBI等の物理書類は案件により異なります。',
              },
            },
            {
              '@type': 'Question',
    ...
    >
      ...
      <SummaryBlock
        ...
        points={[
          ...
          'PSAの電子版は約1週間、紙原本の国際発送は約3〜4週間。NBI等の物理書類は案件により異なります',
      ...
      <SectionDivider variant="beige">
        <IconCardGrid
          ...
          columns={3}
          cards={[
            { icon: Clock, title: '処理期間を確認したい', description: 'PSAの電子版は約1週間、紙原本の国際発送が必要な場合は約3〜4週間が目安です。NBI等は案件により異なります。', accent: 'gold' },
      ...
      <FaqSection
        items={[
          { q: 'DFAアポスティーユにはどのくらいかかりますか？', a: 'DFA e-ApostilleはRegular（通常5日程度）またはExpress（3日程度）で申請できます。PSAの電子版は約1週間、紙原本の国際発送が必要な場合は約3〜4週間が目安です。NBI等の物理書類は案件により異なります。' },
          ...
          { q: '料金はいくらですか？', a: 'PSA民事書類1通は、e-Certificateのみ30,000円、紙原本＋DHL（認証なし）30,000円、e-Apostille付き電子版40,000円、フルセット55,000円です（すべて税込）。' },
