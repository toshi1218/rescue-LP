          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800 leading-relaxed mb-2">
                The PSA now issues CENOMAR, Birth Certificate, and Marriage Certificate exclusively as digital PSA eCertificates with a digital DFA e-Apostille. Walk-in physical Apostille on a printed document is no longer available directly at DFA.
              </p>
              <p className="text-sm text-amber-800 leading-relaxed">
                <strong>Printing an e-Apostille does not make it valid.</strong> US NVC, US Embassy Manila, UAE, and most Japanese authorities still require a physical paper original — we continue to provide it. Canada (IRCC), Australia, and UK authorities that accept e-Apostille PDFs can receive it digitally instead. We confirm the correct format for your case.
              </p>
            </div>
          </div>
        </div>
