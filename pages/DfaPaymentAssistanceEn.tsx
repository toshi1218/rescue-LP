...
const TITLE = 'DFA e-Apostille Payment Assistance from Abroad | US$70';
const DESCRIPTION = 'Cannot pay DFA e-Apostille through LinkBiz from abroad? We make the local payment for a US$70 service fee, or complete the online application and payment for US$150. DFA fees are separate.';
...
export default function DfaPaymentAssistanceEn() {
  ...
  const faqItems = [
    ...
    {
      q: 'Does the US$70 service fee include the DFA or LinkBiz amount?',
      a: 'No. The US$70 is our payment-assistance service fee. The exact DFA or LinkBiz amount shown on your application is charged separately at cost.',
    },
    {
      q: 'What is included in the US$150 Full Application Entry plan?',
  ...
  return (
    ...
    >
      <HeroBanner
        ...
        badges={['Payment Only US$70', 'Full Application + Payment US$150', 'For Overseas Applicants']}
      ...
      <SummaryBlock
        ...
        points={[
          'US$70 service fee when your DFA application is already submitted and only payment remains',
          'US$150 service fee for full online application entry, submission, and payment',
          'The exact DFA or LinkBiz government amount is charged separately at cost',
          'Payment and submission confirmations are sent to you after processing',
        ]}
      ...
      <section className="mb-10">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-secondary/20 bg-white p-6 shadow-sm">
            ...
            <p className="text-4xl font-extrabold text-primary">US$150</p>
            <p className="text-xs text-gray-500 mt-1">Service fee · DFA/LinkBiz amount charged separately</p>
            <ul className="mt-4 space-y-2 text-sm text-gray-700">
      ...
      <FeatureList
        ...
        items={[
          ...
          },
          {
            ...
            description: 'The US$150 plan covers application entry using the information and documents you provide before submission.',
          },
          {
      ...
      <CtaBox
        ...
        href="#contact"
        variant="primary"
        trustNote="Fixed service fee confirmed before payment · Government charges shown separately"
      />
