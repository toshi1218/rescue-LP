    ...
    <div className="min-h-screen bg-background-light text-gray-800 font-body">
      ...
      <main className="max-w-2xl lg:max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-secondary text-white rounded-2xl p-6 mb-10 text-center">
          ...
          <h2 className="text-xl font-bold mb-3">{t('CENOMAR・PSA・NBI、まとめて代行', 'CENOMAR, PSA, NBI – All handled together')}</h2>
          <p className="text-sm text-gray-300 mb-5">
            {t('ビザ申請に必要なフィリピン書類を英語サポートで取得代行。\nまずは無料相談からどうぞ。', 'We retrieve documents for visa application with English support.\nStart with a free consultation.')}
          </p>
        ...
        <section id="contact" className="mb-10">
          <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-soft">
            ...
            <a href="mailto:info@ph-document.com" className="mt-3 inline-flex items-center gap-2 text-xs text-gray-500 hover:text-secondary transition-colors">
              <Mail className="w-4 h-4" />{t('メールで直接送る: info@ph-document.com', 'Send directly: info@ph-document.com')}
            </a>
          </div>
        </section>
      </main>
