        ...
        },
        {
          ...
          mainEntity: [
            ...
            },
            {
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: '提出先によって異なります。PSAの出生証明書・婚姻証明書・CENOMARなどの民事書類は、2026年3月16日以降DFA e-Apostille（電子）のみが発行されます。認証の要否と電子ファイルの提出方法を事前に確認してください。',
              },
            },
          ],
        },
    ...
    >
      ...
      <FaqSection
        items={[
          ...
          { q: '日本への提出にアポスティーユは必要ですか？', a: '提出先によって異なります。PSAの出生証明書・婚姻証明書・CENOMARなどの民事書類は、2026年3月16日以降DFA e-Apostille（電子）のみが発行されます。認証の要否と電子ファイルの提出方法を事前に確認してください。' },
