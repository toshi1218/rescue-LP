    ...
    >
      ...
      <section className="mb-8">
        ...
        <p className="mt-3 text-xs text-gray-500 leading-relaxed">
          If we cannot complete the agreed submission or local payment after receiving complete, accurate information and a valid, unexpired reference, we refund the applicable service fee in full. DFA/LinkBiz and other third-party charges are non-refundable. DFA review, rejection, approval, and issuance are not guaranteed.
        </p>
      </section>
