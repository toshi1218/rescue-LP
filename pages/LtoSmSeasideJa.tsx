      ...
      <FaqSection
        items={[
          ...
          },
          {
            ...
            a: 'はい。日本での外国免許切替（外免切替）にはLTOが発行する運転経歴証明書（運転履歴証明書）が必要です。さらにDFA（フィリピン外務省）でアポスティーユ認証を受けたうえで、日本の都道府県免許センターへ提出します。',
          },
          {
            q: 'SMシーサイドのLTOでどのような書類を取得できますか？',
            a: '運転経歴証明書（Driver\'s Record / 運転履歴証明書）、運転免許証の更新・再発行など、LTOが提供するドライバー関連書類の手続きを行っています。',
          },
          {
