...
export default function GuidesPage() {
  ...
  const categories = [
    ...
    },
    {
      ...
      guides: [
        {
          to: t('/ja/kokusai-kekkon-guide', '/k1-visa-documents'),
          title: t('フィリピン人との国際結婚 完全ガイド', 'K-1 Fiancé Visa: Philippine Documents Guide'),
          desc: t('手続きの流れ・必要書類・費用・期間を初心者向けに解説', 'CENOMAR, PSA Birth Certificate & NBI Clearance with DFA Apostille for K-1'),
          tags: [t('目的別', 'By Purpose'), t('人気', 'Popular')],
          isPopular: true,
        },
        {
          to: t('/ja/haigusha-visa', '/cr1-visa-documents'),
          title: t('配偶者ビザに必要なフィリピン書類', 'CR-1/IR-1 Visa: Philippine Documents Guide'),
          desc: t('配偶者ビザ申請に必要な書類チェックリスト', 'PSA Marriage Certificate & NBI Clearance for NVC submission'),
          tags: [t('目的別', 'By Purpose')],
          isPopular: false,
        },
        {
          to: t('/ja/gaimen-kirikae-guide', '/us-visa-documents'),
          title: t('フィリピン免許→日本免許 外免切替ガイド', 'US Visa Documents: CR-1, IR-1 & K-1 Overview'),
          desc: t('必要なLTO書類・手順・費用を解説', 'All Philippine documents required for US visa applications explained'),
          tags: [t('目的別', 'By Purpose')],
          isPopular: false,
        },
        {
