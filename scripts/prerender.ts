...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    title: `CENOMAR Validity Period ${SEO_TITLE_BADGE_EN}: How Long Is CENOMAR Valid? 6-Month Rule`,
    description: `How long is CENOMAR valid in the Philippines? No legal expiration, but most embassies and immigration offices require CENOMAR within 6 months of issuance. ${SEO_YEAR} guide with use-case breakdown.`,
  ...
  },
  {
    ...
    title: `PSA Birth Certificate ${SEO_TITLE_BADGE_EN}: Requirements, Cost (PHP 365) & How to Get It | Philippine Document Service`,
    description: `What is a PSA Birth Certificate? Complete ${SEO_YEAR} guide: requirements, official fee (PHP 365), how to apply via PSAHelpLine or proxy service. Covers DFA Apostille, NO RECORD FOUND solutions, and international delivery.`,
  ...
  },
  {
    ...
    title: `NBI Clearance Philippines ${SEO_TITLE_BADGE_YEAR_EN}: How to Get It, Cost & NBI HIT Guide | Philippine Document Service`,
    description: `What is NBI Clearance? Complete ${SEO_YEAR} guide: how to get NBI Clearance in the Philippines, requirements, cost, DFA Apostille, NBI HIT resolution, and proxy service with international shipping.`,
  ...
  },
  {
    ...
    title: `DFA Apostille Philippines ${SEO_TITLE_BADGE_EN}: Requirements, Cost (PHP 200+) & How to Get It`,
    description: `What is DFA Apostille? Complete ${SEO_YEAR} guide to Philippines DFA authentication: requirements, cost (PHP 200 standard / PHP 400 express), processing time (10-15 days), eligible documents. Proxy service ships worldwide.`,
  ...
  },
  {
    ...
    title: `DFA Apostille Processing Time ${SEO_TITLE_BADGE_EN}: Standard 10-15 Days, Express 3-5 Days`,
    description: `How long does DFA Apostille take in the Philippines (${SEO_YEAR})? Standard: 10-15 business days. Express: 3-5 days. Cost: PHP 200-400. Complete guide to DFA processing times, requirements, and common delay causes.`,
  ...
  },
  {
    ...
    title: `PSA Birth Certificate Price & Cost ${SEO_TITLE_BADGE_EN} - Official Fee PHP 365+ | Philippine Document Service`,
    description: `How much does a PSA birth certificate cost in ${SEO_YEAR}? Official PSA fee: PHP 365 (~$6.50). PSAHelpLine online: PHP 500-600. Proxy service with DHL shipping: from $199. Full price comparison and DFA Apostille costs inside.`,
  ...
  },
  {
    ...
    title: `DFA Apostille Price & Cost ${SEO_TITLE_BADGE_EN}: PHP 200 Standard, PHP 400 Express | Philippine Document Service`,
    description: `How much does DFA Apostille cost in the Philippines (${SEO_YEAR})? Official fee: PHP 200 (standard) or PHP 400 (express). Proxy service from US$80. Full price breakdown by document type and processing speed.`,
  ...
  },
  {
    ...
    title: `NBI Clearance Validity ${SEO_TITLE_BADGE_YEAR_EN}: How Long Is It Valid? 1-Year Rule | Philippine Document Service`,
    description: `How long is NBI Clearance valid in the Philippines? Officially 1 year from issuance, but many embassies and immigration offices require it within 6 months. ${SEO_YEAR} guide: validity by use case, expiration, and when to apply.`,
