...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    title: `PSA Birth Certificate Cost Philippines ${SEO_YEAR} — PHP 365 + Apostille`,
    description: `PSA Birth Certificate costs PHP 365/copy (${SEO_YEAR}). We retrieve, apostille, and ship worldwide from US$349 all-in. No return trip needed. Free quote.`,
