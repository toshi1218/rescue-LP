...
const routes: RouteConfig[] = [
  /* ── EN canonical routes (/en/*) ─────────────────────── */
  {
    ...
    title: `Philippine Document Service | PSA, NBI & CENOMAR [Mar ${SEO_YEAR}]`,
  ...
  {
    path: '/en/netherlands/',
    outFile: path.join(projectRoot, 'dist', 'en', 'netherlands', 'index.html'),
    title: `PH Documents for Netherlands Immigration (IND) [${SEO_YEAR_MONTH_EN}]`,
    description: `Applying for a Dutch partner visa or MVV? We retrieve CENOMAR, PSA & NBI Clearance with DFA Apostille for IND. Ships to Netherlands via DHL. Free consultation.`,
    canonical: `${BASE}/en/netherlands/`,
    lang: 'en',
    enCanonical: `${BASE}/en/netherlands/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
  },
  {
    ...
    title: `PH Documents for Germany Immigration [${SEO_YEAR_MONTH_EN}]`,
    description: `Applying for a German spouse visa or family reunion? We retrieve CENOMAR, PSA & NBI Clearance with DFA Apostille for the Ausländerbehörde. Ships to Germany via DHL. Free consultation.`,
  ...
  {
    path: '/en/singapore/',
    outFile: path.join(projectRoot, 'dist', 'en', 'singapore', 'index.html'),
    title: `PH Documents for Singapore Immigration (ICA/MOM) [${SEO_YEAR_MONTH_EN}]`,
    description: `Need Philippine documents for Singapore? We retrieve CENOMAR, PSA & NBI Clearance with DFA Apostille for ICA and MOM. Ships to Singapore via DHL. Free consultation.`,
    canonical: `${BASE}/en/singapore/`,
    lang: 'en',
    enCanonical: `${BASE}/en/singapore/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
  },
  {
    path: '/en/hong-kong/',
    outFile: path.join(projectRoot, 'dist', 'en', 'hong-kong', 'index.html'),
    title: `PH Documents for Hong Kong Immigration (ImmD) [${SEO_YEAR_MONTH_EN}]`,
    description: `Need Philippine documents for Hong Kong? We retrieve CENOMAR, PSA & NBI Clearance with DFA Apostille for ImmD. Ships to Hong Kong via DHL. Free consultation.`,
    canonical: `${BASE}/en/hong-kong/`,
    lang: 'en',
    enCanonical: `${BASE}/en/hong-kong/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
  },
  {
  ...
  },
  {
    ...
    title: `NBI Clearance from Overseas [${SEO_YEAR_MONTH_EN}] — No Philippines Trip Needed`,
    description: `Living abroad and need NBI Clearance? We retrieve it without you returning to the Philippines. HIT cases handled. DFA Apostille included. Ships worldwide via DHL. Free consultation for OFWs and visa applicants.`,
  ...
  },
  {
    ...
    title: `PSA No Record Found or Name Error [${SEO_YEAR_MONTH_EN}] — Late Registration & Correction`,
    description: `PSA birth certificate missing, name misspelled, or wrong date? These errors block K-1, CR-1, and spouse visa applications. We explain the correction process and retrieve the fixed document once available.`,
  ...
  },
  {
    ...
    description: 'NBI ClearanceをフィリピンなしのNBI取得。HIT（同名者あり）ケースも対応可。DFAアポスティーユ付きで日本へ郵送。配偶者ビザ・帰化申請・海外就労に。まず無料相談。',
  ...
  },
  {
    ...
    title: `Japan-First vs Philippines-First Marriage [${SEO_YEAR}] — Which Should You Choose?`,
    description: `Comparing Japan-first and Philippines-first marriage for Filipino-Japanese couples. Understand the steps, required documents, timelines, pros and cons of each approach before deciding.`,
  ...
  },
  {
    ...
    description: `Step-by-step guide to Philippines-first marriage for Filipino-Japanese couples. Covers LCCM, Marriage License, ceremony, PSA marriage certificate, and reporting the marriage to Japan.`,
  ...
  },
  {
    ...
    title: `PSA CRS Cebu — How to Get Birth & Marriage Certificates [${SEO_YEAR} Report]`,
    description: `On-site report for the PSA Civil Registration System (CRS) outlet in Cebu City, Colon Street. Appointment required since October 2025. Location, photos, and what documents you can get.`,
  ...
  },
  {
    ...
    title: `Administrative Scrivener vs Document Acquisition Service [${SEO_YEAR}]`,
    description: `Clear comparison of what Japanese administrative scriveners (行政書士) handle vs. what a Philippine document acquisition service handles. When do you need both? A guide for Filipino-Japanese couples.`,
