...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    title: `International Marriage with a Filipino ${SEO_TITLE_BADGE_YEAR_EN}: Step-by-Step Guide, Documents & Cost | Philippine Document Service`,
  ...
  },
  {
    ...
    title: `PSA Marriage Certificate ${SEO_TITLE_BADGE_YEAR_EN}: How to Get It, Cost & Requirements | Philippine Document Service`,
    description: `How to obtain a PSA Marriage Certificate from Japan in ${SEO_YEAR}. Required for international marriage reporting and spouse visa applications. Cost and processing time explained.`,
  ...
  },
  {
    ...
    title: `Philippine License Conversion to Japanese License ${SEO_TITLE_BADGE_EN}: LTO Documents Guide | Philippine Document Service`,
  ...
  },
  {
    ...
    title: `Naturalization in Japan for Filipinos ${SEO_TITLE_BADGE_YEAR_EN}: Required Documents & Process Guide | Philippine Document Service`,
  ...
  },
  {
    ...
    title: `LTO Driver's Record for Gaimen Kirikae (Foreign License Conversion) Philippines ${SEO_TITLE_BADGE_EN} | Philippine Document Service`,
  ...
  {
    path: '/us-visa-documents',
    outFile: path.join(projectRoot, 'dist', 'us-visa-documents', 'index.html'),
    ...
    canonical: `${BASE}/us-visa-documents/`,
    lang: 'en',
    enCanonical: `${BASE}/us-visa-documents/`,
    jaCanonical: `${BASE}/ja/us-visa-documents/`,
    ogType: 'article',
  },
  {
    path: '/k1-visa-documents',
    outFile: path.join(projectRoot, 'dist', 'k1-visa-documents', 'index.html'),
    ...
    canonical: `${BASE}/k1-visa-documents/`,
    lang: 'en',
    enCanonical: `${BASE}/k1-visa-documents/`,
    jaCanonical: `${BASE}/ja/us-visa-documents/`,
    ogType: 'article',
  },
  {
    path: '/cr1-visa-documents',
    outFile: path.join(projectRoot, 'dist', 'cr1-visa-documents', 'index.html'),
    ...
    canonical: `${BASE}/cr1-visa-documents/`,
    lang: 'en',
    enCanonical: `${BASE}/cr1-visa-documents/`,
    jaCanonical: `${BASE}/ja/us-visa-documents/`,
    ogType: 'article',
  },
  {
