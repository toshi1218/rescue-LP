...
const routes: RouteConfig[] = [
  ...
  {
    path: '/en/ched-ecav/',
    outFile: path.join(projectRoot, 'dist', 'en', 'ched-ecav', 'index.html'),
    title: `CHED eCAV Processing Service — Diploma & TOR Authentication for OFWs [2026]`,
    description: `CHED eCAV + e-Apostille for Filipino professionals abroad. Fully electronic since March 2026 — no international shipping needed. From US$99. We handle CHED submission, e-Apostille filing, and university document retrieval.`,
    canonical: `${BASE}/en/ched-ecav/`,
    lang: 'en',
    enCanonical: `${BASE}/en/ched-ecav/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
    datePublished: '2026-07-27',
  },
  {
    path: '/en/prc-certificate/',
    outFile: path.join(projectRoot, 'dist', 'en', 'prc-certificate', 'index.html'),
    title: `PRC Certificate Retrieval + Apostille Service [2026] — Passing, Rating & Good Standing`,
    description: `We retrieve PRC Certificate of Passing, Board Rating, or Good Standing for licensed Filipino professionals abroad, using PRC's scanned-authorization process. DFA Apostille and DHL shipping included. From US$249.`,
    canonical: `${BASE}/en/prc-certificate/`,
    lang: 'en',
    enCanonical: `${BASE}/en/prc-certificate/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
    datePublished: '2026-07-27',
  },
