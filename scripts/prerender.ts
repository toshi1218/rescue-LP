...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    description: `PSA e-Certificate and DFA e-Apostille acceptance by country: Canada, Australia, UK accept PDF. US NVC and UAE require physical paper. Check before ordering.`,
  ...
  },
  {
    ...
    description: `Need a PSA Marriage Certificate from abroad? We retrieve the original, get DFA Apostille, and ship via DHL — from US$349 all-in. No trip needed. Free quote.`,
  ...
  },
  {
    ...
    description: `CR-1/IR-1 spouse visa? We arrange PSA civil records and NBI Clearance identified by the current NVC or embassy checklist, with authentication only when required.`,
  ...
  },
  {
    ...
    description: 'CENOMARはフィリピン渡航なしで取得可能。提出先の要件を確認し、PSA e-Certificate、必要な場合のDFA e-Apostille、別途必要なSECPA紙原本を手配します。',
  ...
  },
  {
    ...
    description: 'CENOMARのPSA e-Certificateと、必要な場合のDFA e-Apostilleをオンラインで代行。2026年3月16日以降の電子発行に対応し、SECPA紙原本は別途必要な場合のみ手配します。',
  ...
  },
  {
    ...
    description: 'フィリピン出生証明書（PSA）を日本から申請代行。必要な場合のDFA e-Apostilleは電子PDF、SECPA紙原本は別途取得・国際配送として、提出先の指定形式に対応します。',
  ...
  },
  {
    ...
    description: '提出先が求めるDFA認証を確認して代行。PSA民事書類は2026年3月16日以降e-Apostille電子PDF、NBI・LTO等は対象に応じた物理認証に対応します。',
  ...
  },
  {
    ...
    description: 'PSA婚姻証明書をフィリピン渡航なしで申請代行。必要な場合のDFA e-Apostilleは電子PDF、SECPA紙原本は別途取得・配送。注釈付きにも対応します。',
  ...
  },
  {
    ...
    description: 'フィリピンのe-Certificate・e-Apostilleは帰化申請に使えるのか。2026年3月16日以降DFAはPSA民事書類へ物理アポスティーユを発行せず、認証は電子のみ。電子認証一式と別途SECPA紙原本の違いを解説。',
  ...
  },
  {
    ...
    description: `For a Korean F-6 spouse visa, we arrange the Philippine documents identified by the current official checklist. PSA authentication is electronic; NBI uses the applicable physical route when required.`,
