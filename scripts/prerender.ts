...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    title: `PSA Birth Certificate ${SEO_TITLE_BADGE_EN}: How to Get It from Japan, Cost & Requirements | Philippine Document Service`,
    description: `Complete guide to getting a PSA Birth Certificate from Japan in ${SEO_YEAR}. Requirements, cost breakdown, proxy service options, and NO RECORD FOUND solutions explained.`,
  ...
  },
  {
    ...
    title: `NBI Clearance ${SEO_TITLE_BADGE_YEAR_EN}: How to Get It from Japan, Cost & NBI HIT Guide | Philippine Document Service`,
