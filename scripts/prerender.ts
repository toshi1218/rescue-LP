...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    description: 'Enter your tracking code and PIN to check the status of your order and upload documents.',
  ...
  },
  {
    ...
    description: '追跡番号とPINを入力して、ご依頼の進捗状況を確認・書類のアップロードができます。',
