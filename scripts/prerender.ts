...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    title: `Get CENOMAR from Abroad [${SEO_YEAR}] — Record & Authentication Options`,
    description: `Get CENOMAR from abroad in the format your receiving authority requests. We arrange the PSA record, electronic authentication when required, and separate paper delivery when requested.`,
  ...
  },
  {
    ...
    description: `CENOMAR means Certificate of No Marriage Record. It may be requested for marriage or immigration, depending on the current checklist and the applicant’s civil history.`,
  ...
  },
  {
    ...
    description: `Get a PSA Birth Certificate from abroad. We arrange the PSA record, electronic DFA Apostille when required, and separate SECPA paper delivery when requested.`,
  ...
  },
  {
    ...
    description: `PSA e-Certificate and DFA e-Apostille guide for the US, Canada, Australia, UK, and UAE. Acceptance depends on the current authority checklist and application stage.`,
    canonical: `${BASE}/en/psa-ecertificate-abroad/`,
    lang: 'en',
    enCanonical: `${BASE}/en/psa-ecertificate-abroad/`,
    jaCanonical: `${BASE}/ja/psa-ecertificate-nihon/`,
    koCanonical: `${BASE}/ko/psa-ecertificate-hanguk/`,
    ogType: 'article',
    datePublished: '2026-04-30',
  },
  {
  ...
  },
  {
    ...
    title: `Philippine Documents for Spouse Visa [${SEO_YEAR}] — PSA, CENOMAR, NBI + Apostille`,
    description: `Which Philippine documents do you need for a spouse visa? PSA Marriage Certificate, CENOMAR, NBI Clearance + DFA Apostille. We retrieve and ship worldwide. Free quote.`,
  ...
  },
  {
    ...
    description: `Need a PSA Marriage Certificate from abroad? We arrange the PSA record, electronic DFA Apostille when required, and separate SECPA paper delivery when requested.`,
  ...
  },
  {
    ...
    title: `Philippine Documents for Naturalization [${SEO_YEAR}] — PSA Birth Certificate + NBI + Apostille`,
    description: `Applying for citizenship? We retrieve PSA Birth Certificate, NBI Clearance + DFA Apostille and ship worldwide. No trip to the Philippines needed. Free quote.`,
  ...
  },
  {
    ...
    title: `DFA Apostille Fee [${SEO_YEAR}] — Official Fee & Total Cost`,
    description: `DFA e-Apostille costs ₱200 for an eligible PSA e-Certificate. Total service cost depends on document retrieval, the required authentication route, and delivery.`,
  ...
  {
    path: '/en/new-zealand/',
    outFile: path.join(projectRoot, 'dist', 'en', 'new-zealand', 'index.html'),
    title: `Philippine Documents for New Zealand Immigration [${SEO_YEAR}]`,
    description: `Applying for a New Zealand partner visa or residence? We retrieve CENOMAR, PSA Birth Certificate & NBI Clearance with DFA Apostille. Ships to NZ via DHL. Free consultation.`,
    canonical: `${BASE}/en/new-zealand/`,
    lang: 'en',
    enCanonical: `${BASE}/en/new-zealand/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
    datePublished: '2026-04-30',
  },
  {
    path: '/en/germany/',
    outFile: path.join(projectRoot, 'dist', 'en', 'germany', 'index.html'),
    title: `Philippine Documents for Germany Immigration [${SEO_YEAR}]`,
    description: `Applying for a German spouse visa or residence permit? We retrieve CENOMAR, PSA Birth Certificate & NBI Clearance with DFA Apostille. Ships to Germany via DHL. Free consultation.`,
    canonical: `${BASE}/en/germany/`,
    lang: 'en',
    enCanonical: `${BASE}/en/germany/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
    datePublished: '2026-04-30',
  },
  {
    path: '/en/cenomar-requirements-by-country/',
    outFile: path.join(projectRoot, 'dist', 'en', 'cenomar-requirements-by-country', 'index.html'),
    title: `CENOMAR Requirements by Country [${SEO_YEAR}] — Complete List`,
    description: `CENOMAR apostille and authentication requirements for every country: USA, Canada, Australia, UK, UAE, Germany, New Zealand, Korea, Japan and more. Updated ${SEO_YEAR}.`,
    canonical: `${BASE}/en/cenomar-requirements-by-country/`,
    lang: 'en',
    enCanonical: `${BASE}/en/cenomar-requirements-by-country/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
  ...
  },
  {
    ...
    lang: 'en',
    enCanonical: `${BASE}/en/cenomar-cost-comparison/`,
    jaCanonical: `${BASE}/ja/`,
    ogType: 'article',
    datePublished: '2026-05-01',
  },
  ...
  },
  {
    ...
    description: `View ${SEO_YEAR} pricing for CENOMAR, PSA Birth Certificate, NBI Clearance & DFA Apostille, including the US$1,249 three-applicant family package.`,
  ...
  {
    path: '/en/tracking/',
    outFile: path.join(projectRoot, 'dist', 'en', 'tracking', 'index.html'),
    title: 'Track Your Order | Philippine Document Service',
    description: 'Open the private customer link sent by IGRS Inc. to check your order status securely.',
    canonical: `${BASE}/en/tracking/`,
    lang: 'en',
    enCanonical: `${BASE}/en/tracking/`,
    jaCanonical: `${BASE}/ja/tracking/`,
    koCanonical: `${BASE}/ko/tracking/`,
    noindex: true,
  },
  {
    path: '/en/privacy/',
...

  {
    ...
    title: `CENOMAR vs PSA Marriage Certificate [${SEO_YEAR}] — Which Do You Need?`,
    description: `CENOMAR = proof you've never been married. PSA Marriage Certificate = proof you are married. Wrong document = visa rejection. We explain and retrieve both.`,
  ...
  },
  {
    ...
    title: `PSA No Record Found? [${SEO_YEAR}] — Late Registration & Name Correction`,
    description: `PSA says "no record found" or has a name error? This blocks K-1, CR-1, and spouse visa. We explain the late registration process and can assist. Free consultation.`,
  ...
  },
  {
    ...
    title: 'PSA e-Certificate取得代行｜海外から¥30,000（税込）・電子納品【IGRS】',
    description: '海外からPSA出生証明書・CENOMAR・婚姻証明書のe-Certificate取得を日本語で代行。本人確認・申請・支払いからPDF納品まで¥30,000（税込）。',
  ...
  },
  {
    ...
    description: 'フィリピン出生証明書（PSA）を日本から取り寄せ代行。電子版は約1週間、紙原本の国際発送は約3〜4週間。追加請求なし。無料相談。',
  ...
  },
  {
    ...
    description: 'フィリピンのe-Certificate・e-Apostille（電子書類）は帰化申請に使えるのか。法務局は今も紙のPSA原本を前提に運用していますが、2026年3月以降DFAはPSA民事書類へ物理アポスティーユを発行せず、認証はe-Apostille（電子）に一本化されました。現在の正しい組み合わせと、提出先への事前確認の仕方を解説。',
  ...
  },
  {
    ...
    outFile: path.join(projectRoot, 'dist', 'ja', 'data-security', 'index.html'),
    title: '個人情報・機密書類のお取り扱い｜SNS・メール添付を使わない理由（IGRS Inc.）',
    description: 'パスポート・PSA出生証明書・CENOMARなどの機密書類の画像を、WhatsApp・Messenger等のSNSチャットやメール添付でやり取りしない理由と、専用環境での受け渡し・業務完了後3ヶ月以内のデータ削除など、当社のセキュリティへの取り組みをご説明します。',
    canonical: `${BASE}/ja/data-security/`,
    lang: 'ja',
    enCanonical: `${BASE}/en/data-security/`,
    jaCanonical: `${BASE}/ja/data-security/`,
    koCanonical: `${BASE}/ko/data-security/`,
    ogType: 'article',
    lastmod: '2026-07-08',
  },
  {
    path: '/ko/data-security/',
    outFile: path.join(projectRoot, 'dist', 'ko', 'data-security', 'index.html'),
    ...
    canonical: `${BASE}/ko/data-security/`,
    lang: 'ko',
    enCanonical: `${BASE}/en/data-security/`,
    jaCanonical: `${BASE}/ja/data-security/`,
    koCanonical: `${BASE}/ko/data-security/`,
  ...
  },
  {
    ...
    outFile: path.join(projectRoot, 'dist', 'en', 'data-security', 'index.html'),
    title: 'How We Protect Your Documents & Personal Data — ph-document.com',
    description: 'Why we never exchange passports, PSA certificates, or CENOMAR images over WhatsApp, Facebook Messenger, or email attachments — and how our secure upload environment, safe payment practices, and 3-month data deletion policy protect you.',
    canonical: `${BASE}/en/data-security/`,
    lang: 'en' as const,
    enCanonical: `${BASE}/en/data-security/`,
    jaCanonical: `${BASE}/ja/data-security/`,
    koCanonical: `${BASE}/ko/data-security/`,
  ...
  },
  {
    ...
    description: '現地PSA料金と代行費用の違いを解説。電子版または紙原本＋DHLは¥30,000、e-Apostille付き電子版¥40,000、フルセット¥55,000（税込）。',
  ...
  {
    path: '/ja/tracking/',
    outFile: path.join(projectRoot, 'dist', 'ja', 'tracking', 'index.html'),
    title: 'ご依頼の進捗確認｜フィリピン書類取得代行センター',
    description: 'IGRS Inc.からお送りしたお客様専用リンクで、ご依頼の進捗状況を安全に確認できます。',
    canonical: `${BASE}/ja/tracking/`,
    lang: 'ja',
    enCanonical: `${BASE}/en/tracking/`,
    jaCanonical: `${BASE}/ja/tracking/`,
    koCanonical: `${BASE}/ko/tracking/`,
  ...
  },
  {
    ...
    description: '介護送迎・社用車・現場移動にフィリピン人従業員を使いたい会社向け。外免切替に必要なLTO書類取得を一括代行。1名99,000円〜（税込・DHL送料込み）。請求書払い・複数名対応。',
  ...
  {
    path: '/ko/psa-ecertificate-hanguk/',
    outFile: path.join(projectRoot, 'dist', 'ko', 'psa-ecertificate-hanguk', 'index.html'),
    ...
    canonical: `${BASE}/ko/psa-ecertificate-hanguk/`,
    lang: 'ko',
    enCanonical: `${BASE}/en/psa-ecertificate-abroad/`,
    jaCanonical: `${BASE}/ja/psa-ecertificate-nihon/`,
    koCanonical: `${BASE}/ko/psa-ecertificate-hanguk/`,
