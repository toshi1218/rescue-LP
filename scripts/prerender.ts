...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    title: `PSA Birth Certificate Cost [${SEO_YEAR}]: PHP 365 + US$219 All-In`,
    description: `Official PSA fee: PHP 365/copy. Full price — retrieval, DFA Apostille & DHL Express: US$219 all-in, 4–6 weeks. No hidden fees. USA, UAE, Canada, UK & more.`,
  ...
  },
  {
    ...
    title: `フィリピン出生証明書 オンライン申請代行【${SEO_YEAR_MONTH_JA}】DFA e-Apostille込み`,
    description: 'フィリピン出生証明書（PSA）を日本から取得する方法。PSAオンライン申請とDFA e-Apostille（電子認証）申請を日本語で代行。2026年3月以降、PSA民事書類の認証はe-Apostilleに一本化。国際結婚・ビザ・帰化に。無料相談受付中。',
  ...
  },
  {
    ...
    description: '現地PSA料金365ペソ＋DFAアポスティーユ＋国際配送の総額を解説。日本から代行依頼で追加請求なし・総額明示。¥30,000（税別）から。無料見積もり。',
