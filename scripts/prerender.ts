...
const routes: RouteConfig[] = [
  ...
  {
    path: '/en/psa-e-apostille-service/',
    outFile: path.join(projectRoot, 'dist', 'en', 'psa-e-apostille-service', 'index.html'),
    title: 'PSA e-Apostille Service — Apply Online From Abroad [2026]',
    description: 'Since March 2026, PSA documents (birth certificate, marriage certificate, CENOMAR) are apostilled only through the online e-Apostille system. OTP, ID verification, and liveness checks can be difficult from abroad — especially when family members have naturalized to a foreign citizenship. We file on your behalf and resubmit until approved.',
    canonical: `${BASE}/en/psa-e-apostille-service/`,
    lang: 'en',
    enCanonical: `${BASE}/en/psa-e-apostille-service/`,
    jaCanonical: `${BASE}/ja/psa-e-apostille-daiko/`,
    ogType: 'article',
  ...
  {
    path: '/ja/psa-e-apostille-daiko/',
    outFile: path.join(projectRoot, 'dist', 'ja', 'psa-e-apostille-daiko', 'index.html'),
    title: 'PSAアポスティーユのオンライン申請代行【2026年最新】海外在住フィリピン人向け',
    description: '2026年3月のDFA完全電子化以降、PSA書類のアポスティーユ（e-Apostille）はオンライン申請のみになりました。OTP・身分証・顔認証を海外から同時に通すのが難しい方、ご家族が外国籍で委任状の署名一致に不安がある方へ。代理申請から却下時の再申請まで対応します。',
    canonical: `${BASE}/ja/psa-e-apostille-daiko/`,
    lang: 'ja',
    enCanonical: `${BASE}/en/psa-e-apostille-service/`,
    jaCanonical: `${BASE}/ja/psa-e-apostille-daiko/`,
    ogType: 'article',
  ...
  {
    path: '/ja/business/gyoseishoshi-e-apostille/',
    outFile: path.join(projectRoot, 'dist', 'ja', 'business', 'gyoseishoshi-e-apostille', 'index.html'),
    title: '行政書士向け e-Apostille申請実務ガイド【2026年3月制度変更後】',
    description: '2026年3月のDFA完全電子化により変わったPSAアポスティーユ申請の実務を解説。OTP・身分証・顔認証の同時通過、外国籍家族の委任状署名不一致による却下と再申請、法務局のe-Apostille受理運用の差。フィリピン側書類取得の実務をIGRSがサポート・代行します。',
    canonical: `${BASE}/ja/business/gyoseishoshi-e-apostille/`,
    lang: 'ja',
    enCanonical: `${BASE}/en/`,
    jaCanonical: `${BASE}/ja/business/gyoseishoshi-e-apostille/`,
    ogType: 'article',
    datePublished: '2026-07-17',
    lastmod: '2026-07-17',
  },
