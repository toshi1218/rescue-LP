...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    description: `DFA Apostille without going to the Philippines — from US$349 all-in. We retrieve PSA, NBI, or CENOMAR and ship via DHL Express worldwide. 4–6 weeks.`,
  ...
  },
  {
    ...
    title: `Philippine Documents for International Marriage [${SEO_YEAR}] — Retrieval Service`,
    description: `Getting married to a Filipino? We retrieve CENOMAR, PSA Birth Certificate + DFA Apostille and ship via DHL worldwide — US$899 all-in. No trip needed.`,
  ...
  },
  {
    ...
    description: `CR-1/IR-1 spouse visa? PSA Marriage Certificate, Birth Certificate + DFA Apostille for NVC — US$899 all-in, ships to your US address. 4–6 weeks.`,
  ...
  },
  {
    ...
    description: '配偶者ビザに必要なPSA書類・CENOMAR・NBI・アポスティーユを一括代行。¥50,000〜（税込）。納期4〜6週間。紙の原本対応。在留資格認定・更新・変更すべて対応。',
